...
- [X] What is the range of Moran's I values across your 3 tessellations? (e.g., 0.32–0.41)
- [X] Are all results significant at p < 0.05? If not, which tessellation(s) show random distribution?
- [X] Which tessellation has the highest Moran's I? (This shows the strongest clustering signal.)
- [X] How many neighbors does each tessellation average? (From Step 6.1 diagnostics.)
- [X] Can you explain _why_ regular tessellations (hex/square) might differ from Voronoi in I values?
:::
